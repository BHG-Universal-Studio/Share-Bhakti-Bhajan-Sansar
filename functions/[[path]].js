export async function onRequest(context) {
  ...
  const ogImage = videoId
    ? `https://res.cloudinary.com/bhguniversalstudio/image/fetch/c_fill,g_center,w_1080,h_1920/l_play_circle_bbmxz9,g_center,w_260,fl_layer_apply/f_jpg,q_auto/https://img.youtube.com/vi/${videoId}/maxresdefault.jpg`
    : `${url.origin}/logo.png`;
